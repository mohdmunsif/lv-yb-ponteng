    ...
    <div>
        <div class="max-w-6xl mx-auto py-10 sm:px-6 lg:px-8">
            ...
            <nav aria-label="navigation">
                <ul class="pagination">
                    <a href="{{ route('parliamentdays.ym', [$prevyear, $prevmonth]) }}"
                    ...
                    <a href="{{ route('parliamentdays.ym', [$nextyear, $nextmonth]) }}"
            ...
            <form method="POST" action="{{ route('parliamentdays.ym-patch', [$year, $month]) }}">
                @csrf
                @method('PATCH')
